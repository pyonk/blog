(() => {
  ...
  function I(n2, l3, u4, t3, i4, r3, o3, e3, f4, c3, s3) {
    ...
    for (f4 = P(u4, l3, _2, f4, m3), a3 = 0; a3 < m3; a3++)
      null != (y3 = u4.__k[a3]) && (h3 = -1 == y3.__i ? p : _2[y3.__i] || p, y3.__i = a3, g2 = O(n2, y3, h3, i4, r3, o3, e3, f4, c3, s3), w3 = y3.__e, y3.ref && h3.ref != y3.ref && (h3.ref && q(h3.ref, null, y3), s3.push(y3.ref, y3.__c || w3, y3)), null == d3 && null != w3 && (d3 = w3), 4 & y3.__u || h3.__k === y3.__k ? f4 = A(y3, f4, n2) : "function" == typeof y3.type && void 0 !== g2 ? f4 = g2 : w3 && (f4 = w3.nextSibling), y3.__u &= -7);
    return u4.__e = d3, f4;
  }
  ...
  function ThemeToggle() {
    ...
    return /* @__PURE__ */ u3(
      "button",
      {
        ...
        children: /* @__PURE__ */ u3("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: theme === "light-theme" ? /* @__PURE__ */ u3("path", { d: "M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" }) : /* @__PURE__ */ u3("circle", { cx: "12", cy: "12", r: "5" }) })
      }
    );
  }
  function MenuToggle() {
    ...
    return /* @__PURE__ */ u3(
      "button",
      {
        ...
        children: /* @__PURE__ */ u3("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
          /* @__PURE__ */ u3("line", { x1: "3", y1: "6", x2: "21", y2: "6" }),
          /* @__PURE__ */ u3("line", { x1: "3", y1: "12", x2: "21", y2: "12" }),
          /* @__PURE__ */ u3("line", { x1: "3", y1: "18", x2: "21", y2: "18" })
        ] })
      }
    );
  }
  function ReadingProgress() {
    ...
    return /* @__PURE__ */ u3("div", { className: "reading-progress", children: /* @__PURE__ */ u3(
      "div",
      {
  ...
  function initializeComponents() {
    ...
    if (themeContainer) {
      ...
      E(/* @__PURE__ */ u3(ThemeToggle, {}), themeContainer);
    } else {
    ...
    if (menuContainer) {
      ...
      E(/* @__PURE__ */ u3(MenuToggle, {}), menuContainer);
    } else {
    ...
    if (document.querySelector("article") || document.querySelector(".post")) {
      ...
      E(/* @__PURE__ */ u3(ReadingProgress, {}), progressContainer);
    }
